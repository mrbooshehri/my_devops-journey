...
* [HAProxy](#haproxy)
   ...
   * [Securing headers](#securing-headers)
   * [Compression](#compression)
      * [1. <strong>Compression Algorithms</strong>](#1-compression-algorithms)
      * [2. <strong>Compression Types</strong>](#2-compression-types)
      * [3. <strong>Compression Offload</strong>](#3-compression-offload)
      * [Compression tips](#compression-tips)
   * [Basic Authentication](#basic-authentication)
   * [HAProxy command line (Make change on the fly)](#haproxy-command-line-make-change-on-the-fly)
      * [Useful commands](#useful-commands)
   * [High Availability](#high-availability)
      * [1. Install HAProxy and Keepalived](#1-install-haproxy-and-keepalived)
      * [2. Configure HAProxy](#2-configure-haproxy)
      * [3. Configure Keepalived](#3-configure-keepalived)
      * [4. Start and Enable Services](#4-start-and-enable-services)
      * [5. Testing](#5-testing)
      * [Important Notes](#important-notes)
      * [Sync haproxy.cfg amoung all nodes](#sync-haproxycfg-amoung-all-nodes)
      * [Syncing memory of HAProxy nodes](#syncing-memory-of-haproxy-nodes)
         * [What is peers](#what-is-peers)
         * [Syncing stick-table](#syncing-stick-table)
   * [Tackling with DDoS attacks](#tackling-with-ddos-attacks)
   * [Stats page](#stats-page)
   * [Handle SNI with HAProxy](#handle-sni-with-haproxy)
      * [Server Name Indiction (SNI)](#server-name-indiction-sni)
         * [Usecases](#usecases)
      * [HAProxy Configuration](#haproxy-configuration-3)
   * [Handling client's IP address](#handling-clients-ip-address)
      * [For mode http](#for-mode-http)
      * [For mode tcp](#for-mode-tcp)
   * [Handling Cross-Origin](#handling-cross-origin)
      * [What is Cross-Origin](#what-is-cross-origin)
      * [HAProxy Config](#haproxy-config)
   * [Using HAProxy as a Databse Loadbalancer](#using-haproxy-as-a-databse-loadbalancer)
   * [Tips](#tips)
